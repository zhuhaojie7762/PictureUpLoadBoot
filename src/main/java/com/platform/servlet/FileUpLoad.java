...
//        StringBuffer mulu = new StringBuffer();
...
//            StringBuffer yearMonthName = new StringBuffer();
...
//                stringBuffer.append("上传完成的图片地址:").append(pics.toString()).append(",在上新表中不存在的货号为:")
//                        .append(noData.toString()).append("的记录,请将对应得货号的数据导入数据库后再次上传对应的图片");
...
//
//        } catch (Exception e) {
//            logger.error("servlet获取spring中的bean异常---------" + e.toString());
//            e.printStackTrace();
//        }
//    }
//
